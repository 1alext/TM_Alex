...
<head>
    ...
    <p class="navigation"><a href="index.php" class="underline">Accueil</a> / Amérique du Sud</p>
    <p class="description-maillot">
    Montre ta passion pour le football sud américain avec ces maillots, parfaits pour les entraînements <br>
...
<body>
<h1 class="titre-produits-europe">Maillots Amérique du Sud</h1>
